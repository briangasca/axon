    ...
    return (
        <div className="flex items-center justify-center min-h-screen w-screen bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900">
            ...
            <div className="bg-white rounded-2xl px-10 py-10 w-full max-w-sm shadow-2xl shadow-black/40 animate-fade-up">
                ...
                <p className="text-sm text-gray-400 mb-5">Sign up to get started</p>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        <label htmlFor='password-register-input' className="text-sm font-medium text-gray-600">Password</label>
                        <input className="bg-gray-50 rounded-lg px-3 py-2.5 text-gray-800 placeholder:text-gray-400 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition" id='password-register-input' type='password' value={password} onChange={(e) => setPassword(e.target.value)} />
                    </div>
                    ...
                    <p className="text-sm text-gray-400 text-center">Already have an account? <span className="cursor-pointer text-blue-600 hover:underline font-medium" onClick={() => navigate('/login')}>Sign in</span></p>
                </form>
